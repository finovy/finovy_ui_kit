...
/// }
/// ```
abstract class RefreshIndicatorState<T extends RefreshIndicator> extends State<T> with IndicatorStateMixin<T, RefreshStatus> implements RefreshProcessor {
  bool _inVisual() {
...
abstract class LoadIndicatorState<T extends LoadIndicator> extends State<T> with IndicatorStateMixin<T, LoadStatus> implements LoadingProcessor {

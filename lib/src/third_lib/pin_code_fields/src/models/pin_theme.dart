...
class PinTheme {
  ...
  /// Color of the input field when in disable mode. Default is [Colors.grey]
  ...
  const PinTheme.defaults({
    ...
    this.selectedColor = const Color(0xFF0058ff),
  ...
  factory PinTheme({
    ...
    return PinTheme.defaults(
      ...
      disableBorderColor:
          disableBorderColor ?? defaultValues.disableBorderColor,

...
class FNUICircularProgress extends StatefulWidget {
  ...
  @override
  FNUICircularProgressState createState() => FNUICircularProgressState();
}

class FNUICircularProgressState extends State<FNUICircularProgress>
  ...
  void _checkIfNeedCancelAnimation(FNUICircularProgress oldWidget) {
  ...
  @override
  void didUpdateWidget(FNUICircularProgress oldWidget) {
